...
| [`protected-branch-guard/`](protected-branch-guard/)               | Layered Git/Codex guards against accidental work on main, with a safe feature-branch helper and integration tests |
